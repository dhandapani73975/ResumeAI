...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-ai-resume-analyzer-key-2026-very-secret')
...
# Simplify static file serving with WhiteNoise storage
...
# Session Cookie and CSRF settings for AJAX compatibility
